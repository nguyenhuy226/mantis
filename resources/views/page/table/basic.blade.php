          ...
          <div class="col-sm-12">
            <div class="card">
              <div class="card-header">
                ...
                <small
                  >DataTables allows ordering by multiple columns at the same time, which can be activated in a number of different
                  ways</small
                >
              </div>
              <div class="card-body">
          ...
          <div class="col-sm-12">
            <div class="card">
              <div class="card-header">
                ...
                <small
                  >The default page control presented by DataTables (forward and backward buttons with up to 7 page numbers in-between) is
                  fine for most situations, but there are cases where you may wish to customizing the options presented to the end
                  user.</small
                >
              </div>
              <div class="card-body">
