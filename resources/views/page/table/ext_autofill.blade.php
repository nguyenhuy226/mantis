            ...
            <div class="row align-items-center">
              <div class="col-md-12">
                <ul class="breadcrumb">
                  ...
                  <li class="breadcrumb-item" aria-current="page">AutoFill</li>
                </ul>
              </div>
              <div class="col-md-12">
                <div class="page-header-title">
                  <h2 class="mb-0">AutoFill</h2>
                </div>
              </div>
            </div>
          </div>
...
@push('scripts')
 ...
 <script src="{{asset('/js/plugins/autoFill.bootstrap5.min.js')}}"></script>
 <script src="{{asset('/js/plugins/dataTables.keyTable.min.js')}}"></script>
 <script src="{{asset('/js/plugins/keyTable.bootstrap5.min.js')}}"></script>
