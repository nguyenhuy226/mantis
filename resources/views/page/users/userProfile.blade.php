                                    ...
                                    <div class="card-body position-relative">
                                        ...
                                        <div class="nav flex-column nav-pills list-group list-group-flush user-sett-tabs"
                                            ...
                                            <a class="nav-link list-group-item list-group-item-action active"
                                                id="user-tab-1" data-bs-toggle="pill" href="#user-cont-1" role="tab">
                                            ...
                                            <a class="nav-link list-group-item list-group-item-action" id="user-tab-3"
                                                ...
                                                <span class="f-w-500"><i class="ti ti-lock m-r-10"></i>Change
                                                    Password</span>
                                            </a>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        ...
                                                        <ul class="list-group list-group-flush">
                                                            <li class="list-group-item"><i class="ti ti-minus me-2"></i>
                                                                At
                                                            ...
                                                            <li class="list-group-item px-0">
                                                                <div
                                                                    ...
                                                                    <div class="d-flex align-items-center">
                                                                        ...
                                                                        <div>
                                                                            <h5 class="mb-1">Setup Email Notification
                                                                            </h5>
                                                                            <p class="text-muted text-sm mb-0">Turn on
                                                                                email
                                                                                notification to get updates through email
                                                                            </p>
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-check form-switch p-0">
                                                            ...
                                                            <li class="list-group-item px-0">
                                                                <div
                                                                    ...
                                                                    <div class="d-flex align-items-center">
                                                                        ...
                                                                        <div>
                                                                            <h5 class="mb-1">Update System Notification
                                                                            </h5>
                                                                            <p class="text-muted text-sm mb-0">You will be
                                                                                notified when customer order any product</p>
                                                                        </div>
