                        ...
                        <div class="card-body">
                            <form>
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-4 col-sm-12 text-lg-end">Limited to 5 values with
                                        remove button</label>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6 col-md-11 col-sm-12">
                                        <input class="form-control custom class" id="choices-text-unique-values"
                                            type="text" value="preset-1, preset-2" placeholder="This is a placeholder">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-4 col-sm-12 text-lg-end">Email addresses
                                        only</label>
                                    <div class="col-lg-6 col-md-11 col-sm-12">
                                ...
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-4 col-sm-12 text-lg-end">Prepends and appends a
                                        value to each items return value</label>
                                    <div class="col-lg-6 col-md-11 col-sm-12">
                                ...
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-4 col-sm-12 text-lg-end">Preset values passed
                                        through options</label>
                                    <div class="col-lg-6 col-md-11 col-sm-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form>
                                ...
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-4 col-sm-12 text-lg-end">Options from remote source
                                    ...
                                    <div class="col-lg-6 col-md-11 col-sm-12">
                                        ...
                                        <small>If the following example do not load, the rate limit has probably been
                                            reached. Try again later!</small>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-4 col-sm-12 text-lg-end">Right-to-left</label>
                            ...
                            <form>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6 col-md-11 col-sm-12">
                                        ...
                                        <small>If the following two examples do not load, the rate limit has probably been
                                            reached. Try again
                                            later!</small>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-4 col-sm-12 text-lg-end">Options added via config
                                        with no search</label>
                                    <div class="col-lg-6 col-md-11 col-sm-12">
                                ...
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-4 col-sm-12 text-lg-end">Option and option groups
                                        added via config</label>
                                    <div class="col-lg-6 col-md-11 col-sm-12">
                                ...
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-4 col-sm-12 text-lg-end">Option selected via config
                                        with custom properties</label>
                                    <div class="col-lg-6 col-md-11 col-sm-12">
                                ...
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-4 col-sm-12 text-lg-end">Option searchable by
                                        custom properties via <code>data-custom-properties</code> attribute</label>
                                    <div class="col-lg-6 col-md-11 col-sm-12">
                                        <select class="form-control" id="choices-with-custom-props-via-html">
                                            ...
                                            <option value="Dropdown item 3"
                                                data-custom-properties="This option is fantastic">Label Three</option>
                                        </select>
                                        <small>Try searching for 'fantastic', "Label 3" should display</small>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-4 col-sm-12 text-lg-end">Options without
                                        sorting</label>
                                    <div class="col-lg-6 col-md-11 col-sm-12">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6 col-md-11 col-sm-12">
                                        ...
                                        <small>
                                            Below is an example of how you could have two select inputs depend on each
                                            other. 'Tube stations' will only be
