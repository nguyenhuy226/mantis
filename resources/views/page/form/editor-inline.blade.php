          ...
          <div class="row align-items-center">
            <div class="col-md-12">
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">Inline Editor</li>
              </ul>
            </div>
            <div class="col-md-12">
              <div class="page-header-title">
                <h2 class="mb-0">Inline Editor</h2>
              </div>
            </div>
          </div>
        </div>
...
@push('form')
<script src="{{asset('/js/plugins/ckeditor/inline/ckeditor.js')}}"></script>
<script>
  (function () {
